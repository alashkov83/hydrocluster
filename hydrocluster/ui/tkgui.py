...
class TkGui(tk.Tk):
    ...
    def __init__(self) -> None:
        ...
        lab1.pack(expand=1, fill=tk.X, pady=2, padx=5)
        lab11 = tk.LabelFrame(lab1, text='Property table', labelanchor='n', borderwidth=5)
        lab11.grid(row=0, column=0, pady=2, padx=5)
        ...
        lab32.grid(row=1, column=0, pady=2, padx=5)
        ...
        self.ent_min_min_samples.grid(row=3, column=1, pady=2, padx=5, sticky="W")
        l5 = tk.Label(lab22, text="Max MIN_SAMPLES:", anchor=tk.W)
        l5.grid(row=4, column=0, pady=2, padx=5, sticky="W")
        ...
        self.ent_max_min_samples.grid(row=4, column=1, pady=2, padx=5, sticky="W")
        but2 = tk.Button(lab2, text='Start', command=lambda: self.run(auto=True))
        but2.grid(row=3, column=0, pady=2)
        self.pb = ttk.Progressbar(lab2, orient='horizontal', mode='determinate', length=220)
        self.pb.grid(row=4, column=0, pady=2, padx=5)
        self.fra3 = tk.Frame(self, width=640, height=480)
        self.fra3.grid_propagate(False)
        self.fra3.grid(row=0, column=1)
        fra4 = tk.Frame(self)
        fra4.grid(row=1, column=1, pady=10)
        self.tx = tk.Text(fra4, width=100, height=6, wrap=tk.WORD)
    ...
    def scan_param(self):
        ...
        b_eps.grid(row=0, column=0, pady=2, padx=5)
        ...
        b_ms.grid(row=0, column=1, pady=2, padx=5)
        b_c = tk.Button(fra2, text="Cancel", command=lambda: win.destroy())
        b_c.grid(row=0, column=2, pady=2, padx=5)
